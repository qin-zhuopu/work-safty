 ...
 * 测试变更管理页面
 */
async function testChangePage(page: Page): Promise<void> {
  console.log("\n=== 测试变更管理页面 ===");

  // 导航到变更管理页面
  await page.goto(`${BASE_URL}/sft/change/index`);
  ...
  // 11. 截图
  await page.screenshot({ path: "screenshots/sft-change.png", fullPage: true });
  console.log("✓ 已保存截图: screenshots/sft-change.png");
...
async function runTests() {
  ...
  try {
    ...
    // 先打开目标页面
    console.log(`\n正在打开页面: ${BASE_URL}/sft/change/index`);
    await page.goto(`${BASE_URL}/sft/change/index`);
