...
async function testRecordPage(page: Page): Promise<void> {
  ...
  // 导航到模拟答题记录页面
  await page.goto(`${BASE_URL}/sft/train/pc/record/index`);
  ...
  await page.screenshot({
    path: "screenshots/sft-train-pc-record.png",
    fullPage: true
  });
  console.log("✓ 已保存截图: screenshots/sft-train-pc-record.png");
...
async function runTests() {
  ...
  try {
    ...
    // 先打开目标页面
    console.log(`\n正在打开页面: ${BASE_URL}/sft/train/pc/record/index`);
    await page.goto(`${BASE_URL}/sft/train/pc/record/index`);
